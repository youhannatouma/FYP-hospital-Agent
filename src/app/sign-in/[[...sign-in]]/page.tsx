      ...
      <div className="hidden md:flex flex-1 bg-primary/5 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="space-y-6">
          <h2 className="text-4xl font-extrabold tracking-tight leading-tight">
            Welcome Back to{" "}
            <span className="text-primary italic">Precision</span> Care.
          </h2>
          <p className="text-muted-foreground text-lg max-w-md">
            Your intelligence-backed health journey continues here. Access your
            records, consult with AI, or book your next specialist.
          </p>
        </div>
