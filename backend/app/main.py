...
from app.models import user, appointment, time_slot, chat
from app.routes import auth, users, appointments, doctors, payments, admin, medical_records, prescriptions, notifications, assistant
...
async def lifespan(app: FastAPI):
    ...
    # ── Create tables ──────────────────────────────────────────────────────
    from app.models import user, appointment, time_slot, medical_record, prescription, notification, chat
