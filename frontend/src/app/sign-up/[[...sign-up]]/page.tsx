        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <h2 className="text-4xl font-extrabold tracking-tight leading-tight">
              Begin Your <span className="text-primary italic">Smart</span> Health Journey.
            </h2>
            <p className="text-muted-foreground text-lg max-w-md font-medium">
              Create your account in seconds and unlock the full potential of AI-driven healthcare.
            </p>
          </div>
          ...
          <SignUp 
            ...
            appearance={{
              elements: {
                ...
                formFieldInput: "rounded-xl border-border bg-muted/30 focus:border-primary focus:ring-primary h-11",
