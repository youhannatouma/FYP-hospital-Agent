...
export default function CommunicationSupportPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[80vh] text-center">
      ...
      <h1 className="text-3xl font-black tracking-tight mb-2">Comms & Support</h1>
      <h2 className="text-xl font-bold text-muted-foreground uppercase tracking-widest">Coming Soon</h2>
      <p className="mt-4 text-muted-foreground max-w-md">
        The support ticketing and broadcast messaging system is currently under development. 
